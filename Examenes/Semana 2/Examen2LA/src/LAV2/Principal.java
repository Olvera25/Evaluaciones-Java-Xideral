...
public class Principal {
	...
	public static void main(String[] args) {
		...
		*/
		try (Scanner sc = new Scanner(System.in)) {
			...
			//Creamos las lambdas 
			//En esta la condición para que se imprima el alumno el nombre debe tener un tamaño mayor a 5
			mostrarAlumno(listaAlumnos, w -> w.getNombre().length()>5);
			
			//En esta la condición para que se imprima es que la matricula sea mayor a 1500
			mostrarAlumno(listaAlumnos, w -> w.getMatricula() > 1500);
	...
	static void mostrarAlumno(List<Alumno> lista, Predicate<Alumno> p ) {
